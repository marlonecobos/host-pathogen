...
#' @param permanova_variables (character) name of variables to used in plots when 
...
#'                   permanova_variables = NULL, breaks = "Sturges", 
#'                   main = "", xlab = NULL, ylab = NULL, h_col = "lightgray", 
#'                   h_cex = 0.8, lty = 2, lwd = 1, l_col = c("blue", "black"), 
#'                   pch = 19, pt_cex = c(1.3, 0.8), 
#'                   pt_col = c("black", "red"), ...)

plot_niche_signal <- function(niche_signal_list, statistic = "mean", 
                              permanova_variables = NULL, ellipses = FALSE, 
                              level = 0.99, breaks = "Sturges", main = "", 
                              xlab = NULL, ylab = NULL, h_col = "lightgray", 
                              h_cex = 0.8, lty = 2, lwd = 1, l_col = c("blue", "black"), 
                              e_col = c("black", "red"), pch = 19, pt_cex = c(1.3, 0.8), 
                              pt_col = c("black", "red"), ...) {
